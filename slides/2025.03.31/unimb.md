...
<div style="position: absolute; top: 50%; right: 2%; width: 30%;">
<p><strong>Geoffrey Hinton</strong> (esquerda) e <strong>Demis Hassibs</strong> (direita) ganhadores de Nobel de Física e Química contribuições em IA.</p>
</div>
...
<img src="images/artificial_analysis_intelligence_index_frontier_models_20250521.png" style="position: absolute; top: 20%; left: 10%; width: 85%;">
...
<div class="content-title" style="position:absolute; left:10%; top:10%">Melhoria vs Transformação</div>
...
<div class="content-title right">Efeito Baumol</div>
...
![bg](images/template-closing-unimb.png)
